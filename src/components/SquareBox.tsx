    ...
    <>
      {rowNumber === 1 || columnNumber === 1 ? (
        rowNumber === 1 && columnNumber === 1 ? (
          ...
          <span
            onClick={() => (isMoves ? dispatch(spreadColorFromLeft({ item, rowNumber })) : null)}
          ...
          <span
            onClick={() => (isMoves ? dispatch(spreadColorFromTop({ item, rowNumber: 0 })) : null)}
            onDragOver={allowDrop}
        ...
        rowNumber === height && columnNumber === width ? (
          ...
          <span
            onClick={() => (isMoves ? dispatch(spreadColorFromBottom({ item, rowNumber: 0 })) : null)}
            onDragOver={allowDrop}
        ...
        <span
          onClick={() => (isMoves ? dispatch(spreadColorFromRight({ item, rowNumber })) : null)}
          onDragOver={allowDrop}
